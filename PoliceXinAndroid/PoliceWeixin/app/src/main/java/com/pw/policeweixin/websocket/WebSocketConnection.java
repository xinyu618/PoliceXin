...
public class WebSocketConnection implements WebSocket {
	...
	private void failConnection(final int code, final String reason) {
	...
	@Override
	public void connect(final String wsUri, final WebSocket.ConnectionHandler wsHandler) throws WebSocketException {
		connect(wsUri, null, wsHandler, new WebSocketOptions(), null);
	}

	@Override
	public void connect(final String wsUri, final WebSocket.ConnectionHandler wsHandler, final WebSocketOptions options)
			throws WebSocketException {
		connect(wsUri, null, wsHandler, options, null);
	}

	public void connect(final String wsUri, final String[] wsSubprotocols, final WebSocket.ConnectionHandler wsHandler,
			final WebSocketOptions options, final List<BasicNameValuePair> headers) throws WebSocketException {
	...
	protected boolean scheduleReconnect() {
		/**
		 * Reconnect only if: - connection active (connected but not disconnected) - has previous success connections -
	...
	Handler mMasterHandler = new Handler() {
		...
		public void handleMessage(final Message msg) {
			...
			if (msg.obj instanceof WebSocketMessage.TextMessage) {
				...
				failConnection(WebSocketConnectionHandler.CLOSE_INTERNAL_ERROR, "WebSockets internal error ("
				...
				failConnection(WebSocketConnectionHandler.CLOSE_SERVER_ERROR, "Server error " + error.mStatusCode
